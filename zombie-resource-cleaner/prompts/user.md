...
## EIP Special Handling

```
Execute EIP deletion (requires DNS check):
- Resource ID: eip-1234567890abcdef0
- EIP Address: 203.0.113.42
- enable_eip_dns_check: true

Before deletion:
1. Check DNS system for A records pointing to this EIP
...
Output:
- delete/eip_dns_check_report.json
- delete/eip_notification_log.json
- delete/deletion_record_eip-1234567890abcdef0.json
```
