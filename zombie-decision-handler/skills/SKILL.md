...
**Prompt file:** `prompts/generate-decision-report.agent.md`
**Agent workflow:**
...
**Prompt file:** `prompts/execute-decisions.agent.md`
**Agent workflow:**
...
**Prompt file:** `prompts/deliver-final-report.agent.md`
**Agent workflow:**
